...
- Secure user management and authentication with Prisma and NextAuth.js
- Powerful data access & management tooling on top of Mysql with [Prisma](https://www.prisma.io/)
